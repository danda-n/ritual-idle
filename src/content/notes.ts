...
export const NOTES = [
  ...
  },
  {
    ...
    steps: [
      ...
      { id: "light.beeswax", label: "Pour 6 beeswax candles (Chandlery 2)", goal: { kind: "complete", action: "beeswax_candle", count: 6 }, reward: { omen: "still_night" } },
  ...
  },
  {
    ...
    steps: [
      ...
      { id: "ward.sweep", label: "Sweep the hearth 18 times (Scavenging 2)", goal: { kind: "complete", action: "sweep_hearth", count: 18 }, reward: { surge: true } },
      { id: "ward.sigil", label: "Draw 10 ash sigils (Sigilcraft 2)", goal: { kind: "complete", action: "ash_sigil", count: 10 }, reward: { xpChoice: { amount: 40, suggest: "scavenging" } } },
  ...
  },
  {
    ...
    unlocks: ["herbalism"],
    steps: [
      { id: "smoke.nettle", label: "Pick 30 nettle", goal: { kind: "complete", action: "pick_nettle", count: 30 }, reward: { xpChoice: { amount: 100, suggest: "herbalism" } } },
      ...
      { id: "smoke.smudge", label: "Bind 15 smudge bundles (Chandlery 2)", goal: { kind: "complete", action: "smudge_bundle", count: 15 }, reward: { xpChoice: { amount: 100, suggest: "chandlery" } } },
      { id: "smoke.mugwort", label: "Pick 8 mugwort (Herbalism 2)", goal: { kind: "complete", action: "pick_mugwort", count: 8 }, reward: { surge: true } },
      { id: "smoke.incense", label: "Burn 4 mugwort incense (Chandlery 3)", goal: { kind: "complete", action: "mugwort_incense", count: 4 }, reward: { xpChoice: { amount: 60, suggest: "scavenging" } } },
  ...
  },
  {
    ...
    gift: "still_night",
    steps: [
      { id: "words.candles", label: "Pour 10 tallow candles to read by", goal: { kind: "complete", action: "tallow_candle", count: 37 }, reward: { xpChoice: { amount: 100, suggest: "scavenging" } } },
      ...
      { id: "words.litany", label: "Copy the Litany (Scholarship 2)", goal: { kind: "complete", action: "copy_litany", count: 1 }, reward: { omen: "still_night" } },
  ...
  },
  {
    ...
    unlocks: [],
    steps: [
      { id: "perform.smoke", label: "Smoke the rooms twice (Ritualism 2)", goal: { kind: "complete", action: "smoke_rooms", count: 2 }, reward: { surge: true } },
    ],
    goal: { kind: "rite" },
  },
  {
